...
<body>
    ...
    <!-- HERO TITLE Warning -->
    <div class="py-5" style="background: linear-gradient(135deg, #1E293B, #0F172A); border-bottom: 1px solid #334155;">
        <div class="container text-center">
            <i class="fas fa-exclamation-circle fa-3x mb-3 text-warning"></i>
            <h1 class="fw-bold text-white">Pusat Kendali Peringatan</h1>
            <p class="mb-0 text-white-50">Kelola notifikasi bahaya yang ditampilkan ke publik</p>
        </div>
    </div>
    ...
    <div class="container my-5">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h4 class="fw-bold m-0 text-white">Daftar Peringatan Sistem</h4>
            <button class="btn btn-warning fw-bold rounded-pill px-4 shadow-lg" data-bs-toggle="modal" data-bs-target="#addAlertModal">
                <i class="fas fa-plus-circle me-2"></i> Buat Alert Baru
            </button>
        </div>
            ...
            <div class="col-md-6">
                ...
                <div class="admin-card h-100 p-4 <?php echo $isActive ? '' : 'opacity-50'; ?>" style="<?php echo $isActive ? 'border-left: 5px solid '.($isDanger ? '#ef4444' : '#f59e0b') : ''; ?>">
                    <div class="d-flex justify-content-between mb-3">
                        ...
                        <small class="text-white-50"><?php echo formatTanggalIndonesia($alert['created_at']); ?></small>
                    </div>
                    
                    <h5 class="fw-bold text-white"><?php echo htmlspecialchars($alert['pesan']); ?></h5>
                    <p class="text-white-50 mb-4">Lokasi: <?php echo htmlspecialchars($alert['lokasi']); ?></p>
